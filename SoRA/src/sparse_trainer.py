...
class SparseTrainer(Trainer):
    def __init__(self, *args, sparse_lambda=0.1, sparse_optimizer=None, **kwargs):
    ...
    def train(
        ...
        **kwargs,
        ...
        print("I'm here in SparseTrainer's train!!!")
        """
    ...
    def _inner_training_loop(
        ...
        print("I'm here in SparseTrainer's inner training loop!!!")
