...
from src.sparse_trainer import SparseTrainer
...
def main():
    ...
    if training_args.train_sparse:
        ...
        sparse_optimizer = SparseAdamW(sparse_lambda=sparse_args.sparse_lambda_2,
                                       lambda_schedule=sparse_args.lambda_schedule,
                                       max_lambda=sparse_args.max_lambda, lambda_num=sparse_args.lambda_num,
    ...
    logger.info(
        "***** Final Model ******\nLora rank: %d\nNumber of trainable full param: %d\nNumber of trainable sparse param: %d, Ratio: %.4f%%\n**********" % (
            config.lora_r, total_param, sparse_param, sparse_param / total_param * 100))
