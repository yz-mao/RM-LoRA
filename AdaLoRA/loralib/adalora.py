...
class RankAllocator(object):
    ...
    def get_lora_param_name(self):
        # print('I am in get lora_param_name!!!!!!!!!!!!!!!!!!!!!!!!!')
        ...
        # print("self.name_set:", len(self.name_set))   # 72   # 72*4=288
    ...
    def update_ipt(self, model): 
        for n,p in model.named_parameters():
            ...
            if "lora_" in n:
                ...
                # print(f"Parameter: {n}, requires_grad: {p.requires_grad}, grad: {'exists' if p.grad is not None else 'None'}")
    ...
    def mask_to_target_rank(self, model, curr_rank):
        # print("I'm in mask_to_target_rank")
        is_dict = {}
        combine_dict = {} 
        singular_dict = {}
        ...
        # print("All_is is:", torch.cat(all_is).size())   # torch.Size([288])
        # print("self.total_rank-curr_rank is:", self.total_rank-curr_rank)
    ...
    def update_and_mask(self, model, global_step):
        # print("I'm in update_and_mask")
        # print(global_step)

        if global_step!=0 and global_step < self.total_step-self.final_warmup:
